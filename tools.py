    ...
    if len(dirs) == 0:
        ...
        for dir_path in dirs:
            ...
            if leng <= threshold:
                ...
                leng_corre = len(
                    [file.name for file in os.scandir(corresponding_dir) if file.name.split(".")[-1] in img_format])
                print(
                    "dir name:{}, quantity of origin:{}, quantity of removal:{}".format(dir_path.split("\\")[-1], leng,
                                                                                        leng_corre))
